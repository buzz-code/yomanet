            ...
            <article className="container instruction">
                ...
                <ol style={{ listStyleType: "hebrew" }}>
                    ...
                    <li>
                        ...
                        <p>
                            בלשונית מערכת תוכן – בתוך תיקית log – תקית LogPlayBack – LogPlayStop
                            <br />
                            המערכת מיצרת קבצים בפורמט html יומיים – יש להוריד את הקבצים ולשמרם בתקיה.
                            <br />
                            בתפריט העלאת קבצים ניתן להעלות קבצי האזנה או קבצי ועידה.
                        </p>
                        <p>
                            הערה: אם המערכת לא מיצרת את הקבצים – יש להכנס להגדרות מערכת של כל שלוחה ולהוסיף את השורות
                            הבאות.
                            <pre>
